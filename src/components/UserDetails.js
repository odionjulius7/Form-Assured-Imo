      ...
      <Form className="container">
        <div className="container form-content m-1">
          <p className="form_content-p">
            In completing the Proposal Form, please ensure that questions are
            answered fully and accurately and where necessary schedules giving
            further explanation are provided.
          </p>
          <div className="form_content-div">
            ...
            <p className="form_content-p">
              It is your duty to disclose all material facts to Underwriters. A
              material fact is one that is likely to influence an Underwriter’s
              judgement and acceptance of your proposal. If your proposal is a
              renewal of an existing policy, it should also include any change
              in facts previously advised to Underwriters. If you are in any
              doubt as to whether or not facts are considered material, you
              should disclose them. “An Insurance Agent who assists an applicant
              to complete an application or proposal for insurance shall be
              deemed to have done so as the agent of the applicant”. Please note
              that the completion of this form is not evidence of insurance
              contract. Linkage Assurance Plc is not on risk until full premium
              is paid and relevant contract documents issued.
            </p>
          </div>
          <div className=" form_content-announce">
            ...
            <div>
              ...
              <span className="form_content-p">
                ...
                property. Loss of or damage to the insured vehicle by accident,
                fire or theft, hurricane, earthquake, volcanic eruption, flood
                or any convulsion of nature, riot, strike or civil commotion.
              </span>
            </div>
            <div>
              <h4 className="form_content-h4">(b) THIRD PARTYFIRE & THEFT</h4>
              <span className="form_content-p">
                Third Party liability for injury to persons and damage to
                property. Loss of or damage to the insured vehicle by fire or
                theft
              </span>
            </div>
            <div>
              ...
              <span className="form_content-p">
                Third Party liability for injury to persons and damage to
                property. Policies (a), (b) and (c) include the cover required
        ...
        >
          <Form.Label className="label form-group-label">
            <span className="form-group-span">8:</span> <em>Email Address:</em>
          </Form.Label>
          <Form.Control
