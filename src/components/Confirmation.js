...
export default function Confirmation() {
  ...
  return (
    <>
      <div id="downloadable" className="col-md-12">
        <Row>
        ...
        <Row>
          ...
          <Row>
            <p className="pdf-p">
              ...
              <span className="no-span">LECON FINANCIAL SERVICES LIMITED</span>
            </p>
            <p className="pdf-p">
              3. Effective Date of Commencement of Insurance for the purposes of
              the Ordinance(s): <span className="no-span">April 13, 2022</span>
            </p>
            <p className="pdf-p">
            ...
            <Row>
              ...
              <row>
                ...
                <p className="">
                  ...
                  Motor Vehicle or has been so permitted and is not disqualified
                  by order of a Court of Law or by reason of any enactment or
                  regulation in that behalf from driving such Motor Vehicle.
                </p>
              </row>
            </Row>
            <row>
      ...
      >
        <Col>
          <p className="">...Protection that counts</p>
        </Col>
        <Col>
          <p className="">
