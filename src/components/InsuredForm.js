      ...
      <Form className="container mt-5 mb-4">
          ...
          <tbody className="bod-width">
            ...
            <tr>
              ...
              <td>
                <div className="first-radio-btn d-flex mt-2">
                  <Form.Group className="mb-2 d-flex " controlId="formAddress">
                    <Form.Label style={{ marginRight: "2rem" }}>Yes</Form.Label>
                    <Form.Check
                      name="cartageFOP"
                      type="radio"
                      value="yes"
                  ...
                  <Form.Group className="mb-2 d-flex " controlId="formAddress">
                    <Form.Label style={{ marginRight: "2rem" }} className="">
                      No
                    </Form.Label>
                    <Form.Check
                      name="cartageFOP"
            ...
            <tr>
              <td className="tr-width" colSpan={2}>
                ...
                heavier than that stated in the Maker's published specification
              </td>
              <td>
                <div className="first-radio-btn d-flex mt-2">
                  <Form.Group className="mb-2 d-flex " controlId="formAddress">
            ...
            <tr>
              ...
              <td>
                ...
                <Form.Control
                  type="text"
                  defaultValue={this.props.inputValues.classOfVehicleLicence}
        ...
        <section>
          <p className="mt-4 mb-3">
            NB. Please read the following declaration very carefully and read
            again the questions and answers especially if not completed in your
            <br />
          ...
          <div className="section-content mt-2 mb-4">
            <h5>Declaration</h5>
            <p>I/We declare that to the best of my/our knowledge and belief:</p>
            <p>(a) the above answers are true </p>
            <p>
              (b) all material particulars affecting the assessment of the risk
              have been disclosed{" "}
            </p>
            <p>
          ...
          <div className="section-form mb-5">
            <p>
              ...
              of the contract between me/us and the Insurers and shall be deemed
              to be incorporated in such contract.{" "}
            </p>
            ...
            >
              <Form.Label className="label pb-3">
                <span className="form-group-span">&nbsp;</span> <em>Name:</em>
              </Form.Label>
              <Form.Control
                isInvalid={
            ...
            <div className="container div-file d-flex">
              ...
              >
                ...
                <Form.Control
                  ...
                  // size="sm"
                  onChange={(event) =>
                    this.props.handleFileChange(event.target.files[0] || null)
                  }
                />
              </Form.Group>
              <Form.Group
              ...
              >
                <Form.Label className="label pb-3">
                  <span className="form-group-span">&nbsp;</span> <em>Date:</em>
                </Form.Label>
                <Form.Control
                  isInvalid={
        ...
        <Button className="back-btn" variant="secondary" onClick={this.back}>
          Back
        </Button>{" "}
