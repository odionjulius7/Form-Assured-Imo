        ...
        <Form>
          ...
          <Table bordered>
            ...
            <tbody>
              ...
              <tr>
                <td className="table-h">(h) Carrying or Seating Capacity </td>
                <td className="table-c">
                  <Form.Control
                    isInvalid={
          ...
          <p>
            (Please use a separate sheet if more than three vehicles are to be
            insured)
          </p>
          &nbsp;
          <h4 style={{ textAlign: "center" }}>
            ...
            <tbody>
              <tr>
                <td style={{ textAlign: "center" }}>
                  Indicate cover required - tick ( * ) appropriate box <br />
          ...
          <span>&nbsp;</span>
          <h4 style={{ textAlign: "center" }}>SECTION D: USE OF VEHICLE(S)</h4>
          <Table bordered>
            <tbody>
              <tr>
                <td className="first-tr-edit" style={{ paddingLeft: "3rem" }}>
                  <p className="first-p-edit" style={{ paddingBottom: "2rem" }}>
                  ...
                  <p>
                    ...
                    <br /> travelling or the carriage of goods and samples (i.e.
              ...
              <tr>
                <td className="first-tr-edit" style={{ paddingLeft: "3rem" }}>
                  <p style={{ paddingBottom: "2rem" }}>
                    ...
                    and are they registered in your name? <br />
                  ...
                  <p>
                    ...
                    <br /> If ‘Yes’ state name and address of finance company.
                  </p>
                </td>
                <td className="">
                  <div className="first-radio-btn d-flex mt-2">
